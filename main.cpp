...
public:
    ...
    friend ostream& operator<<(ostream& os,CTablero *tablero);
    void limpiando_tablero() const{
        for (int i = 0; i < lado; ++i) {
            delete[] tablero[i];
        }
        delete[] tablero;
...
ostream& operator<<(ostream& os,CTablero *tablero){
    if(tablero->lado==11)
        os<<"==============================="<<endl;
    else
        os<<"======================================================="<<endl;
...
void ejecutando_operaciones(int lado,int n_casillas, const string& jugador1, const string& jugador2,const string& play){
    ...
    if(play == "multijugador") {
        while (true) {
            ...
            cout << Tablero;//imprime el tablero
        ...
        cout << "Limpiando garabatos :)"<<endl;
        Tablero->limpiando_tablero();
        cout << "listo.....todo limpio !!!!!"<<endl;
        ...
        cout << "|     0. Salir de juego        |"<<endl;
        cout << "|     Seleccione la opcion:    |"<< endl;
        cout << "*==============================*"<<endl;
        getline(cin,opcion);
        validar_dato(opcion,4);
        switch (stoi(opcion)) {
            case 1:
                ejecutando_operaciones(lado,n_casillas,jugador1,jugador2,"un_solo_jugador");
                break;
            case 2:
                ejecutando_operaciones(lado,n_casillas,jugador1,jugador2,"multijugador");
                break;
            case 3:
                menu();
                break;
